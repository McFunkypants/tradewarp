// this is the hacked version of frank force's zzfx 
// that caches sounds for reuse (made by keith clark)
// see https://keithclark.github.io/ZzFXM/

// example: build an explosion sound for use later
// const boom = zzfxG(...[,,333,.01,0,.9,4,1.9,,,,,,.5,,.6]);
// Later, play the sound anytime
// zzfxP(boom);
